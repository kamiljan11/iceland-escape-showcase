...
const routes: RouteItem[] = [
  {
    ...
    desc: {
      ...
      pl: "Najsłynniejsza trasa Islandii — Þingvellir, Geysir i Gullfoss w jeden dzień. Idealna na początek.",
      is: "Frægasta leiðin — Þingvellir, Geysir og Gullfoss á einum degi. Fullkomin fyrir byrjendur.",
    },
    distance: "230 km",
  ...
  },
  {
    ...
    desc: {
      ...
      pl: "Czarne plaże, potężne wodospady i laguna lodowcowa. Najbardziej fotogeniczna trasa na Islandii.",
      is: "Svartir sandstrandir, stórkostlegir fossar og jökullón. Ljósmyndalegasta akstursleiðin.",
    },
    distance: "360 km",
  ...
  },
  {
    ...
    desc: {
      en: "The ultimate Iceland road trip — 1,322 km circling the entire island. See everything in 7–10 days.",
      pl: "Najlepsza trasa dookoła Islandii — 1322 km wokół całej wyspy. Wszystko w 7–10 dni.",
      is: "Fullkomna Íslandsferðin — 1.322 km í kringum landið. Sjáðu allt á 7–10 dögum.",
    },
    distance: "1,322 km",
  ...
  },
  {
    ...
    desc: {
      en: "\"Iceland in miniature\" — volcanoes, lava fields, fishing villages & the mystical Snæfellsjökull glacier.",
      pl: "\"Islandia w miniaturze\" — wulkany, pola lawy, wioski rybackie i mistyczny lodowiec Snæfellsjökull.",
      is: "\"Ísland í smáu\" — eldfjöll, hraunbreiður, sjávarbæir og dularfullur Snæfellsjökull.",
    },
    distance: "170 km",
...
const heading = {
  ...
  desc: {
    ...
    pl: "Zaplanuj swoją podróż z naszymi przewodnikami tras. Każdy zawiera dystans, zalecany typ pojazdu i obowiązkowe przystanki.",
    is: "Skipuleggðu vegferðina þína. Hver leið inniheldur vegalengd, ráðlagðan bíl og áfangastaði sem ekki má missa af.",
  },
};
...
const PopularRoutes = () => {
  ...
  return (
    <section id="routes" className="py-24 bg-gradient-dark">
          ...
          {routes.map((r, i) => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${r.colorClass} flex items-center justify-center flex-shrink-0`}>
                  <Route className="w-6 h-6 text-primary-foreground" />
                </div>
                <div>
                  <h3 className="font-heading text-xl font-bold">{t(r.name, lang)}</h3>
                  <div className="flex flex-wrap gap-3 mt-1 text-xs text-muted-foreground font-body">
              ...
              <p className="text-secondary-foreground text-sm font-body leading-relaxed mb-4">{t(r.desc, lang)}</p>
              <div className="flex flex-wrap gap-2">
                {r.stops[lang].map((stop) => (
                  <span key={stop} className="text-xs px-2.5 py-1 rounded-full bg-secondary text-secondary-foreground font-body">{stop}</span>
                ))}
              </div>
            </motion.div>
          ))}
