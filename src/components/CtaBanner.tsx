    ...
    <section className="py-20 md:py-28 bg-gradient-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="font-heading text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 md:mb-6"
        >
        ...
        <motion.p
          ...
          className="text-muted-foreground text-sm md:text-lg max-w-xl mx-auto mb-8 md:mb-10 font-body"
        >
          {t({
